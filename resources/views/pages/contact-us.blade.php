            ...
            <div class="col-md-8 col-sm-12">
                ...
                <form   method="POST">
                    ...
                    <div class="form-group">
                        <input class="form-control input-box" type="email" name="rating" placeholder="Your Email" autocomplete="off">
                    </div>

                    <!-- Form Group -->
                    <div class="form-group">
                        <input class="form-control input-box" type="text" name="rating" placeholder="Your Name" autocomplete="off">
                    </div>

                    <!-- Form Group -->
                    <div class="form-group">
                        <input class="form-control input-box" type="text" name="title" placeholder="Message Header" autocomplete="off">
                    </div>

                    <!-- Form Group -->
                    <div class="form-group">
                        <input class="form-control input-box" type="text" name="description" placeholder="Message Description" autocomplete="off">
                    </div>
