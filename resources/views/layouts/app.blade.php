...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/mentor-bootstrap-4-admin-dashboard-template/index-job-portal.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Feb 2023 01:34:09 GMT -->
...
<head>
    ...
    <!-- app favicon -->
    <link rel="shortcut icon" href="/d_assets/images/favicon.png" type="image/x-icon">
    <!-- google fonts -->
    <link href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700" rel="stylesheet">
    <!-- plugin stylesheets -->
    <link rel="stylesheet" type="text/css" href="/d_assets/css/vendors.css" />
    <!-- app style -->
    <link rel="stylesheet" type="text/css" href="/d_assets/css/style.css" />
</head>
...
<body>
                            ...
                            <ul class="navbar-nav nav-right ml-auto">
                                                        ...
                                                        <a href="javascript:void(0)">
                                                            <div
                                                                ...
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid"
                                                                        src="/d_assets/img/avtar/03.jpg" alt="user3">
                                                                </div>
                                ...
                                <li class="nav-item dropdown user-profile">
                                    <a href="javascript:void(0)" class="nav-link dropdown-toggle "
                                        ...
                                        aria-haspopup="true" aria-expanded="false">
                                        <img src="/d_assets/img/avtar/02.jpg" alt="avtar-img">
                ...
                <aside class="app-navbar">
                    ...
                    <div class="sidebar-nav scrollbar scroll_light">
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li><a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i
                                        class="nav-icon ti ti-calendar"></i><span class="nav-title">Blog</span></a>
                                <ul aria-expanded="false">
                                    <li> <a href=''>Blog Posts</a> </li>
                                    <li> <a href=''>Add Blog Post</a> </li>
                                </ul>
                            </li>
    ...
    <!-- plugins -->
    <script src="/d_assets/js/vendors.js"></script>

    <!-- custom app -->
    <script src="/d_assets/js/app.js"></script>
</body>


<!-- Mirrored from themes.potenzaglobalsolutions.com/html/mentor-bootstrap-4-admin-dashboard-template/index-job-portal.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Feb 2023 01:34:13 GMT -->
